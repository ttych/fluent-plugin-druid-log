...
class FormatDruidAuditLog2FilterTest < Test::Unit::TestCase
  ...
  sub_test_case 'format audit log' do
    ...
    test 'it should format timeseries query audit log' do
      ...
      expected_event = {
        ...
        'query' => DRUID_TIMESERIES_QUERY_1
      }
  ...
  def create_driver(conf = BASE_CONF)
    Fluent::Test::Driver::Filter.new(Fluent::Plugin::FormatDruidAuditLog2Filter).configure(conf)
  end
